...
define("T_BOOKINGS_SEASONS",	"".AC_DB_PREFIX."bookings_seasons");		# seasons
#
...
define("AC_ADMIN_PUBLIC"		, "".AC_CALENDAR_PUBLIC."admin/");
...
define("AC_ADMIN_ROOT"		, AC_ROOT."admin/");
