...
<table>
	<tr>
		...
		<td><input type="text" name="mod[title]" value="'.$row_config["title"].'" style="width:250px;"></td>
	</tr>
	<tr>
		<td>'.$lang["cal_url"].'</td>
		<td><input type="text" name="mod[cal_url]" value="'.$row_config["cal_url"].'" style="width:250px;"></td>
	</tr>
	<tr>
		<td>'.$lang["default_lang"].'</td>
		<td>
			<select name="mod[default_lang]" class="select" style="width:270px;">
				'.$list_languages_config.'
			</select>
		</td>
	</tr>
	<tr>
		<td>'.$lang["num_months"].'</td>
		<td>
			<select name="mod[num_months]" class="select" style="width:270px;">
	...
	<tr>
		...
		<td>
			<select name="mod[start_day]" class="select" style="width:270px;">
	...
	<tr>
		...
		<td>
			<select name="mod[date_format]" class="select" style="width:270px;">
	...
	<tr>
		<td>'.$lang["theme"].'</td>
		<td>
			<select name="mod[theme]" class="select" style="width:270px;">
				'.$list_themes.'
			</select>
		</td>
	</tr>	
