...
$bt_add='<br/><a id="add_prop" href="index.php?page=items&action=new" title="'.$lang["tip_add_new_item"].'">'.$lang["bt_add_item"].'</a>';
...
if(mysql_num_rows($res)==0){
	...
	while($row=mysql_fetch_assoc($res)){
		...
		$list_items.='<option value="'.$row["id"].'"';
                ...
                //SETTING APARTMENT ID INTO SESSION
	...
	if( ($_REQUEST["id_item"]) && (!in_array($_REQUEST["id_item"],$user_items)) ){
		...
		$the_file=AC_INLCUDES_ROOT."cal.incnew.php";
		...
		var url_ajax_cal 		= '".AC_DIR_AJAX."calendar.ajax_new.php'; 	//	ajax file for loading calendar via ajax
					...
					<div id="instt_cal">
						...
						<table id="key-table" align="right">
							<tr>
								...
								<td width="240" align="center"><div id="inst_cal">'.$lang["inst_calendar_click"].'</div></td>
							</tr>
						</table>
